...
\index{Do@{Do}!Loop@{Loop}}\index{Loop@{Loop}!Do@{Do}}\item[{\em 
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000017}{Todo}]implement for loop execution \end{DoxyRefDesc}


\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000018}{Todo}]implement do loop execution \end{DoxyRefDesc}
