...
Defines types of Nodes \begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000001}{Bug}]unary minus missing \end{DoxyRefDesc}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000002}{Todo}]concatenate some of these types to one type with different values 

implemetn local functions and namelists \end{DoxyRefDesc}
...
\end{DoxyReturn}
\hypertarget{classNode_acc70d98952c4b061bc433c00180b7011}{}\index{Node@{Node}!execute@{execute}}
\index{execute@{execute}!Node@{Node}}
\subsubsection[{execute}]{\setlength{\rightskip}{0pt plus 5cm}int Node\+::execute (
\begin{DoxyParamCaption}
\item[{{\bf Environment} \&}]{env}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{classNode_acc70d98952c4b061bc433c00180b7011}
...
Reimplemented in \hyperlink{classTest_a579d613526a8fc37c15b461e2f07e65e}{Test}, \hyperlink{classBinop_ac905eda0640f64cd28ed5c65b4c0c125}{Binop}, \hyperlink{classLoop_a32977a6ab0e1311d78c603db03f895d4}{Loop}, and \hyperlink{classCondition_a59fde5772e9f804f86001c04cfce39ce}{Condition}.
...
Reimplemented in \hyperlink{classTest_adeefe4160992fad5d3a52584f69a420d}{Test}, \hyperlink{classBinop_a25a4913ef0d2ec9787df24c391734094}{Binop}, \hyperlink{classLoop_a657b90074652fce7ab2028bdc3747b7b}{Loop}, and \hyperlink{classCondition_addf79a820326e04e58937c9875afe181}{Condition}.
...
Moves the end element to the front \begin{DoxyRemark}{Remarks}
