...
\end{DoxyReturn}
\begin{DoxyRemark}{Remarks}
This small hack limits variables to integers, but enables binops to be stored in memory 
\end{DoxyRemark}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000004}{Todo}]Fix this somehow? \end{DoxyRefDesc}
